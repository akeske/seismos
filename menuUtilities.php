...
<ul>
   ...
   <li class='has-sub'><a href='#'><span>4st&nbsp;utility</span></a>
	...
	$rows1 = mysql_num_rows(mysql_query("SELECT * FROM memory WHERE memory=1"));
	$rows2 = mysql_num_rows(mysql_query("SELECT * FROM memory WHERE memory=2"));
	$rows3 = mysql_num_rows(mysql_query("SELECT * FROM memory WHERE memory=3"));
	?>
