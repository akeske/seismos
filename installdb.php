			...
			<td align="center">
				...
				<br>
					<?php
						...
						// Create database
						$query1="CREATE DATABASE IF NOT EXISTS seismosdb";
						if (mysql_query($query1)) {
							print ("Database created successfully <br>");
						} else {
							print ("Error in creating database: <br><br>". mysql_error ());
						}
						mysql_select_db("seismosdb", $con)or die("A MySQL error has occurred.<br />Your Query: " . $your_query . "<br /> Error: (" . mysql_errno() . ") " . mysql_error())."\n";
						// Create table
